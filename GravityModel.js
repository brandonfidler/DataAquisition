...
(function ($) {
    'use strict';
    var $submitButton = $('[id="filename"]'),
        $requiredFields = $('[aria-required="true"]'),
        formErrors = {
            loc: "Enter Line Location",
            spacing: "Enter Station Spacing.",
            nread: "Enter Measurements per Station",
            base: "Enter Base Station Location",
            bfreq: "Enter Value in minutes"
        };
